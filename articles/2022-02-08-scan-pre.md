---
title: "【Swift, Combine】didSetのoldValueに相当する値をCombineで使う方法"
emoji: "🔖"
...
- 初期値を設定したくない場合 -> zip()とdropFirst()を使う
...
```
このときに `sink()` の `receiveValue` で didSet の oldValue に相当する値を用いて処理したくなったのが、動機になります。
